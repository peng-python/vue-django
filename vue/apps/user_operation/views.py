...
class UserFavViewSet(mixins.CreateModelMixin, mixins.ListModelMixin, mixins.RetrieveModelMixin,
    ...
    permission_classes = (IsAuthenticated, IsOwnerOrReadOnly)  # 判断当前用户是否登录
...
class LeavingMessageViewSet(mixins.ListModelMixin, mixins.DestroyModelMixin,
                            mixins.CreateModelMixin, viewsets.GenericViewSet):  # 用户留言
...
class AddressViewSet(viewsets.ModelViewSet):  # 收货地址管理
    permission_classes = (IsAuthenticated, IsOwnerOrReadOnly)
    authentication_classes = (JSONWebTokenAuthentication, SessionAuthentication)
